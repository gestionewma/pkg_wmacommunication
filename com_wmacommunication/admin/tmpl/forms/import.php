...
<div class="container-popup p-3">
    ...
    <p><?= Text::_('COM_WMACOMMUNICATION_IMPORT_DESC') ?></p>

    <form action="<?= Route::_('index.php?option=com_wmacommunication&task=forms.doimport') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <small class="text-muted"><?= Text::_('COM_WMACOMMUNICATION_IMPORT_FILE_DESC') ?></small>
        </div>
